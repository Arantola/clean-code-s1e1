...
const addButton            = document.querySelector(".add-task__btn");              // Add-task button
const incompleteTaskHolder = document.querySelector(".task-list_incomplete-tasks"); // ul of incomplete-tasks
const completedTasksHolder = document.querySelector(".task-list_completed-tasks");  // ul of completed-tasks
